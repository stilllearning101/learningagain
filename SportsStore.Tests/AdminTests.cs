...
namespace SportsStore.UnitTests
{
    ...
    public class AdminTests
    {
        ...
        public void Index_Contains_All_Products()
        {
            ...
            // Action
            Products[] result = ((IEnumerable<Products>)target.Index().
        ...
        public void Can_Edit_Product()
        {
            ...
            AdminController target = new AdminController(mock.Object);
            // Act
            Products p1 = target.Edit(1).ViewData.Model as Products;
            Products p2 = target.Edit(2).ViewData.Model as Products;
            Products p3 = target.Edit(3).ViewData.Model as Products;
            // Assert
        ...
        public void Cannot_Edit_Nonexistent_Product()
        {
            ...
            AdminController target = new AdminController(mock.Object);
            // Act
            Products result = (Products)target.Edit(4).ViewData.Model;
            // Assert
